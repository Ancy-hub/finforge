...
<head>
    ...
    <title>Edit Income - Smart FinForge</title>
...
<div class="main-content">
    ...
    <div class="card form-card">
        <form action="${pageContext.request.contextPath}/incomes?action=edit" method="post" novalidate>
            ...
            <div class="form-group">
                ...
                <input type="text" id="source" name="source" class="form-control"
                       value="${income.source}" required maxlength="100"/>
            </div>
